...
outputtxfile = open('outputERC20trx6.txt', 'a')
...
for i in range(len(address)):
    payload = {'module': 'account', 'action': 'tokentx',
               'address': address[i], 'apikey': 'UDQYZ59SVS5WHH56JYTZA5WC9N6XEZW2GX'}
...
print("The total sum of Transactions (ETH) in all addresses is:",
      (sum/1000000000000000000))
string2 = "The total sum of Transactions (ETH) in all addresses is:", (
    sum/1000000000000000000)
outputtxfile.write(str(string2))
outputtxfile.close()


# old APIKEY: UDQYZ59SVS5WHH56JYTZA5WC9N6XEZW2GX AJZ71AEG686X2KR34DQHSJVJSN2K6E8S1A
